...
public class ProductService {
	 ...
	 * System.out.println("inside getActiveProducts"); List<Product> active
	 * =productReository.findByStatus("active");
	 * 
	 * 
	 * return active; }
	 */
	...
	public List<Product> getActiveProducts(String status) {
		System.out.println("inside ProductService.getActiveProducts");
	 ...
	 * System.out.println("inside ProductService.productById");
	 * productReository.findById(null)
	 * 
	 * 
	 * }
	 */
